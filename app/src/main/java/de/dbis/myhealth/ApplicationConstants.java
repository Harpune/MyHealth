...
public class ApplicationConstants {
    ...
    public static final String SPOTIFY_CLIENT_ID = "80bc97cddf9a4a0fa1fa5df30c6f1cd8";
    public static final String SPOTIFY_REDIRECT_URI = "https://de.dbis.myhealth/callback";
    ...
    public static final String FIREBASE_COLLECTION_SESSIONS = "session";
